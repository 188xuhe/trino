        ...
        extends AbstractTestQueryFramework
{
    ...
    protected QueryRunner createQueryRunner()
            throws Exception
    {
        HiveMinioDataLake hiveMinioDataLake = closeAfterClass(new HiveMinioDataLake(BUCKET_NAME, HIVE3_IMAGE));
    ...
    public void testFlushMetadataCacheAfterTableCreated()
    {
        ...
        String location = "s3://%s/%s".formatted(BUCKET_NAME, "test_flush_intermediate_tmp_table");
        ...
        assertQueryFails("TABLE flush_metadata_after_table_created", "\\Qline 1:1: Table 'delta_lake.default.flush_metadata_after_table_created' does not exist");

        ...
        implements JdbcClient
{
    ...
    private void invalidateTableCaches(SchemaTableName schemaTableName)
    {
        ...
        invalidateAllIf(tableHandlesByNameCache, key2 -> key2.tableName.equals(schemaTableName));
        tableHandlesByQueryCache.invalidateAll();
        invalidateAllIf(tableNamesCache, key1 -> key1.schemaName.equals(Optional.of(schemaTableName.getSchemaName())));

        ...
        implements IClassListener
{
    ...
    static Optional<Class<?>> classWithMeaninglessTestAnnotation(Class<?> realClass)
    {
        for (Class<?> clazz = realClass; clazz != null; clazz = clazz.getSuperclass()) {
            ...
            if (testAnnotation != null && isAllDefaults(testAnnotation, org.testng.annotations.Test.class)) {
    ...
    private static <T extends Annotation> boolean isAllDefaults(T annotationInstance, Class<T> annotationClass)
    {
        try {
